...
void testAddObject(ObjectStore& store) {
    ...
    ObjectStore::Metadata firstObjectMetadata("type1", "url1", "fetched_url1", nullptr, nullptr, std::chrono::system_clock::now());
    ObjectStore::Metadata secondObjectMetadata("type2", "url2", "fetched_url2", nullptr, nullptr, std::chrono::system_clock::now() + std::chrono::minutes(1));
