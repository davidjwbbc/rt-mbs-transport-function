...
public:
    ...
    std::shared_ptr< DistSession > distSession() { return m_createReqData->getDistSession();};
...
private:
    void createRspDataAndSend(std::shared_ptr<MBSTFDistributionSession> distributionSession, const nf_server_interface_metadata_t *api, const nf_server_app_metadata_t *app_meta,ogs_sbi_stream_t *stream, ogs_sbi_request_t *request);
