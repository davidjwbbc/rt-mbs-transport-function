...
public:
    ...
    MBSTFObjectStore();
    ~MBSTFObjectStore();
    void addObject(const std::string& object_id, ObjectData &&object,const std::string& type);
...
private:
    Metadata populateMetadata(const std::string& type);
